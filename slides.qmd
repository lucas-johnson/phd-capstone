...
::: {.column width="55%"}
![](figures/lidar_linmod_test_scatter.png){width=100% fig-align='center'}
:::
...
![](figures/lidar_pub.png){width='100%' fig-align='center'}
...
![](figures/landsat_pub.png){width='100%' fig-align='center'}
...
:::{.column width='70%'}
![](figures/uncertainty_contributions.png){fig-align='center' width='100%'}
:::

:::


## Simple models to expedite this process
